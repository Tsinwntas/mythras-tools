...
export const folkMagic = [
  ...
  },
  {
    ...
    tags: 'Instant, Touch',
    description:
      'Repair fixes physical damage to an inanimate object. Each separate successful casting repairs ld3 Hit Points of damage.',
  },
  {
    name: 'Repugnance',
    tags: 'Concentration, Ranged, Resist (Willpower)',
...
export const sorceryMagic = [
  ...
  },
  {
    ...
    tags: 'Resist (Willpower/Endurance)',
    description:
      'Enhance allows a sorcerer to increase a physical or mental trait of a target. It works in precisely the same way as Diminish, save that it improves a specific characteristic, enhancing it by h points per Intensity of the spell – to a maximum of twice the original characteristic value. Malevolent use of the spell may be resisted.\nCareful consideration should be taken before permitting characters access to certain versions of this spell, such as Enhance (DEX, INT or POW), due to the potentially unbalancing nature of these spells.',
  },
  {
    name: 'Enlarge',
    tags: 'Resist (Special)',
  ...
  },
  {
    name: 'Haste',
    tags: "-",
    description: "Haste augments the Movement Rate of whatever it is cast on, whether a person, creature or object. The spell can affect targets up to a maximum SIZ of three times the Intensity of the spell. Under its effect, the recipient's Movement Rate is increased by an amount equal to the Intensity. If the target is an inanimate object, it increases the top speed of the vehicle or vessel, but does not provide motive power.",
  },
  {
    name: 'Hide Life',
    tags: "-",
  ...
  },
  {
    ...
    description:
      "Hinder reduces the Movement Rate of whatever it is cast on, in a similar manner to Haste. The spell can affect targets of up to a maximum SIZ of three times the spell's Intensity. Those that fail to resist are slowed by a number of metres equal to the Intensity. However, a target's Movement Rate cannot be lowered to less than l metre per round with this spell.",
  },
  {
    name: 'Holdfast',
    tags: 'Resist (Endurance)',
